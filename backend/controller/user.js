...
const fs = require("fs");
// jwt and sendMail removed — email activation system has been disabled
...
router.post("/create-user", upload.single("file"), async (req, res, next) => {
  try {
    ...
    if (userEmail) {
      // if user already exits, delete uploaded file if any
      if (req.file) {
    ...
    // Directly create user in database — no email activation needed
